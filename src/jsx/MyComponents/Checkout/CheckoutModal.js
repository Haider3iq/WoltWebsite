...
import CridetCardComponent from "../smallerCoponents.js/CridetCard";
import CustomerAddressesModal from "../Customer/CustomerAddressesModal";
...
const selectableData = [
...

  {
    ...
    //                 </div>
    //                 <input type={"text"} max="3" className="input txt" placeholder="4542 9931 9292 2293"/>
    //               </div>
    //             </div>
    //             <div className="row">
    ...
    //                 </div>
    //                 <input type={"text"} max="3" className="input txt" placeholder="123" maxLength={3}/>
    //               </div>
    //             </div>
    //             <div className="row">
    //               <div className="field">
    ...
    //                 </div>
    //                 <input type={"text"} max="3" className="input txt"placeholder="JOHN DEAP" />
    //               </div>
    //             </div>
...
export default function CheckoutModal({setShowModal, data, showModal}) {



  
      const [cridetCardName, setCridetCardName] = useState({}) 


      const [numberOfOrders, setNumberOfOrders] = useState(1)
      const [price, setPrice] = useState(12)
      const [steps, setSteps] = useState(0)
      const [cridetCard, setCridetCard] = useState(false);
      const [paymentOk, setPaymentOk] = useState(false)
      const [changeAddress, setChangeAddress] = useState(false)
      
      const [address, setAddress] = useState("403 Oakland Ave Street, A city, Florida, 32104")

      const [cridetCardInfo, setCridetCardInfo] = useState(null);
  ...
  // if(!changeAddress) {
  //   document.getElementById("parentScroll").style.overflow="hidden"; 
  // } else {
  //   document.getElementById("parentScroll").style.overflow="scroll"; 
  // }
}, [changeAddress])
    ...
    // const changeAddressDiv = document.getElementById("customerAddressDiv");




   const changeAddressFunction = () => {
        const addressText = document.getElementById("addressText");
        const changeAddressDiv = document.getElementById("customerAddressDiv");
        console.log("clicked")

          setChangeAddress(it =>!it)
   }
  ...
  return (
    ...
    <div className="checkoutModal"  >
        ...
        <div id="belowMainDiv" className="childDiv">
        ...
        <div className="closeDiv" onClick={setShowModal}>
            <IoCloseCircle/>
        </div>
			...
			<div >
              ...
              {!changeAddress &&  <>
              <div id="addressText" className="addressText">
							{"Adam Johnson"}
                ...
                {changeAddress && <div id="customerAddressDiv" className="customerAddressDiv">
                    <CustomerAddressesModal setAddress={setAddress}/>  
                    {/* <SelectableItems/> */}
                </div> }
							</div>
                  ...
                  <div onClick={changeAddressFunction} className="changeAddressButton">

                    <div >
                        {!changeAddress ? "Change" : "Done"}
                    </div>

                        <div >
                          	< FaShippingFast className="addressIcon" size={20}/>
                        </div>
          ...
          { steps === 0 &&<div>
            ...
            <>
					...
					{steps === 1 && <PaymentMethodList rest={cridetCard ? false : true}/>}
					</fieldset>}

           {/* <div>
              <div id="aboveCridetCardDiv" className="aboveCridetCardDiv">
              
                <div onClick={() => {setCridetCard(false); setPaymentOk(false)}} className="backText">
                    {"Back"}
                  </div>
              ...
              {"Cridet card info"}
                  ...
                  <div onClick={() => {setCridetCard(true); setPaymentOk(true)}} className="nextText">
                    {"Done"}
                  </div>
        ...
        <div className="bottomWidget">
                            ...
                            <div  onClick={() => changeStepts()} className="priceButton">

                            <div>
                                {steps === 1 ? "Order Now" : "Next Step"}
                                </div>
                              
                               {steps === 1 ?   <div className="nextIcon">
                                   <IoBagCheck/>
                                </div> : 
